...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	dynamic5hPolicyRepository := repository.NewDynamic5hPolicyRepository(db)
	dynamic5hPressureService := service.ProvideDynamic5hPressureService(accountRepository, dynamic5hPressureCache, configConfig, userRepository, dynamic5hPolicyRepository)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService, dynamic5hPressureService)
